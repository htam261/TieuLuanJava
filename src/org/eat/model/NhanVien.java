...
public class NhanVien extends KhachHang implements Comparable<KhachHang>,
		Serializable {
	...
	public NhanVien(String id, String hoTen, String matKhau, String diaChi,
			String email, String soDienThoai, boolean laNhanVien) {
