...
public class login extends JFrame implements ActionListener {
	...
	private void loginMethod() {
		...
		KhachHangCollection khcol = new KhachHangCollection(
				khdb.getAllKhachHang());
	...
	public void exitProgram() {
		int selValue = JOptionPane.showConfirmDialog(this,
				"Are you sure to exit program ?", "Confirmation",
