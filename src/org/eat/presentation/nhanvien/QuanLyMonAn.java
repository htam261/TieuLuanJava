...
public class QuanLyMonAn extends JFrame implements ActionListener, ListSelectionListener {
	...
	public void addMenu() {/*
		...
		mnuFileWriteoDisk = new JMenuItem("Write Data to disk");
		mnuFileOpenDateFromDisk = new JMenuItem("Open Data from disk");
	...
	public void loadTable() {
		...
		for (int i = 0; i < colma.size(); i++) {
			...
			dtmHoaDon.addRow(new Object[] {
					m.getMaMonAn(), m.getTenMonAn(),m.getHinhAnh(), l ,m.getMoTa(),m.getGia()
			});
		}
	}
