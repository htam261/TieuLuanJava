...
public class mnMonAn extends JInternalFrame implements ActionListener, ListSelectionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(btnCateNew)) {
			...
			if (maSelected != null) {
				int option = JOptionPane.showConfirmDialog(null, "Báº¡n cÃ³ cháº¯c xÃ³a mÃ³n Äƒn: " + maSelected.getMaMonAn(),"ThÃ´ng bÃ¡o !", JOptionPane.YES_NO_OPTION);
				if (option == 0) {
				...
				JOptionPane.showMessageDialog(null, "Báº¡n chÆ°a chá»�n mÃ³n Äƒn");
			}
		}
	}
	@Override
	...
	private String[] header = new String[] {"MÃ£ mÃ³n Äƒn","TÃªn mÃ³n Äƒn","HÃ¬nh áº£nh","Loáº¡i", "MÃ´ táº£", "GiÃ¡"};
